...
const Typewriter = (() => {
  const PHRASES = [
    ...
    'Pentesting · Hardening · Automation',
...
const Terminal = (() => {
  const LINES = [
    ...
    { delay: 3000, cls: 't-bar-fill', text: '███████████', inline: true },
    { delay: 3000, cls: 't-bar-empty', text: '░', inline: true },
    { delay: 3000, cls: 't-ok',     text: '  95%', newline: true },
    { delay: 3150, cls: 't-highlight', text: '[cybersec]    ', inline: true },
    { delay: 3150, cls: 't-bar-fill', text: '██████████',  inline: true },
    { delay: 3150, cls: 't-bar-empty', text: '██', inline: true },
    { delay: 3150, cls: 't-info',   text: '  88%', newline: true },
    { delay: 3300, cls: 't-highlight', text: '[networking]  ', inline: true },
    { delay: 3300, cls: 't-bar-fill', text: '███████████', inline: true },
    { delay: 3300, cls: 't-bar-empty', text: '░', inline: true },
    { delay: 3300, cls: 't-ok',     text: '  92%', newline: true },
    { delay: 3450, cls: 't-highlight', text: '[web-dev]     ', inline: true },
    { delay: 3450, cls: 't-bar-fill', text: '█████████',   inline: true },
    { delay: 3450, cls: 't-bar-empty', text: '███', inline: true },
    { delay: 3450, cls: 't-info',   text: '  78%', newline: true },
    { delay: 3750, cls: 't-blank',  text: '' },
    { delay: 3850, cls: 't-prompt', text: 'david@server:~$ ' },
    { delay: 3850, cls: 't-cmd',    text: 'sudo nmap -sV --open target', newline: true },
    { delay: 4600, cls: 't-output', text: 'Starting Nmap 7.95 ( nmap.org )', newline: true },
    { delay: 4900, cls: 't-ok',     text: '[✓] 443/tcp  open  https', newline: true },
